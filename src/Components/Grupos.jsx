            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="mt-5 md:mt-3 flex flex-col gap-4 ">
                ...
                <div className="flex items-center">
                  ...
                  <div className="bg-loginbutton cursor-pointer w-full md:w-fit self-center mt-3 md:self-end text-white font-bold py-1 px-2 md:px-5 md:ml-6 rounded transition duration-200 ease-in-out hover:bg-loginbuttonhover focus:outline-none text-sm">
                    Finalizar Tarea
                  </div>
                </div>
              </div>
